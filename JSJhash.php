...
$time1 = ($time1*1000);
$amount1 = (1/($time1/1000));
$dot   = '.';
$pos = strpos($amount1, $dot);
$amount1 = substr($amount1,0,($pos+2));
echo "<br>Did a JSJhashes in <span style='position:absolute;left:200px;'>$time1 miliseconds means</span><span style='position:absolute;left:500px;'>$amount1 hashes per second</span>";
$time_start = microtime(true);
$sha512 = hash('sha512',$pass);
$time_end = microtime(true);
$time2 = $time_end - $time_start;
$time2 = ($time2*1000);
$amount2 = (1/($time2/1000));
$dot   = '.';
$pos = strpos($amount2, $dot);
$amount2 = substr($amount2,0,($pos+2));
echo "<br>Did a sha512 hash in <span style='position:absolute;left:200px;'>$time2 miliseconds means</span><span style='position:absolute;left:500px;'>$amount2 hashes per second</span>";
$fraction = ($time1/$time2);
$dot   = '.';
$pos = strpos($fraction, $dot);
$fraction = substr($fraction,0,($pos+2));
echo "<br>In the time of a JSJhash there could have been $fraction sha512 hashes!!!";
echo "<br><a href='JSJhash.html'>Terug</a>";
?>