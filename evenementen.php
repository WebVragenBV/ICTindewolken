		...
		getAllEvents(function(data){
			...
			for(var i in data){
				getFotoLink(i, 0,data[i][0]['id'], function(fotolink, i){
					document.getElementById('restaurants').innerHTML += "<div style='background:url(" + fotolink + ")'><b>" + data[i][1]['titel'] + "</b> " + data[i][2]['omschrijving'].substring(0,80) + "... <a href='evenement.php?id=" + data[i][0]['id'] + "'>Lees meer</a>";
				})
			}
		});
            ...
            <header>
                ...
                <nav>
                    <ul class="center">
                        ...
                        <li class='current' id='item2'><a href="#">Evenementen</a></li>
