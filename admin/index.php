...
<html>
		...
		getFirstEvents(function(data){
			for(var i in data){
				getFotoLink(i, 0,data[i][0]['id'], function(fotolink, i){
					document.getElementById('events').innerHTML += "<div style='background:url(" + fotolink + ")'><b>" + data[i][1]['titel'] + "</b> " + data[i][2]['omschrijving'].substring(0,80) + "... <a href='restaurant.php?id=" + data[i][0]['id'] + "'>Lees meer</a>";
				})
			}
		})
	...
	<?php include_once 'IPblok.php'; ?>
        <div id="wrap">
			...
			<div style="height:100px;width:100px;color:red;"></div>
            <section id="content">
                <section id='slider'>
					<figure>
						<div id="img" style='background:url(http://edno.bg/assets/SAW_2013/UN/UN03.jpg)' alt='slider'></div>
						<figcaption>Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet.</figcaption>
					</figure>
				</section>
